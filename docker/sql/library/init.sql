...
INSERT INTO Book (ISBN, Title, Author, Number_of_pages, Year, Publisher_Name)
VALUES
('9000000000001', 'Книга 1', 'Мега Автор', 150, 1999, NULL),
('9000000000002', 'Книга 2', 'Мега Автор', 160, 1999, NULL),
('9000000000003', 'Книга 3', 'Мега Автор', 170, 1999, NULL),
('9000000000004', 'Книга 4', 'Мега Автор', 180, 1999, NULL),
('9000000000005', 'Книга 5', 'Мега Автор', 190, 1999, NULL),
('9000000000006', 'Книга 6', 'Мега Автор', 200, 1999, NULL)
ON CONFLICT (ISBN) DO NOTHING;
INSERT INTO Book (ISBN, Title, Author, Number_of_pages, Year, Publisher_Name)
VALUES ('9000000000099', 'Супер-толстая книга', 'Толстой Автор', 5000, 1980, NULL)
ON CONFLICT (ISBN) DO NOTHING;
INSERT INTO Category (CategoryName, ParentCat)
VALUES ('Спорт', NULL)
